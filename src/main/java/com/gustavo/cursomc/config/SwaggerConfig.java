...
public class SwaggerConfig {
	...
	@Bean
	public Docket api() {
		// Docket é um objeto que contém a configuração do swagger
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("API do curso Spring Boot",
				"Esta API foi desenvolvida no curso de Spring Boot do prof. Nelio Alves", 
				"Versão 1.0",
				"https://www.udemy.com/terms",
				new Contact("Gustavo Cruz", "github.com/GustavoSC1", "gu.cruz17@hotmail.com"),
